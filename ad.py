...
# Params = np.array([1.2,1. ,0.3*10**(-3),1.,1.,0.3*10**(-3)])
# Params = np.array([0.0001, 0.0001,0.3*10**(-3), 0.000001, 0.000001, 0.8*10**(-3)]) # plot 3
Params = np.array([1,1, 0.3 * 10**(-3),1, 1, 0.3 * 10**(-3)]) # plot 2
...
ax.set_xticks([-1.5e-13, -0.75e-13, 0.])
